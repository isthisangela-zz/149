...
// TODO: Interrupt pin? Is this pin an interupt pin? Is an interrupt pin an input (1, x)?
...
// From library using onboard radio.
// bool init() {
...
//  Serial.println(spiRead(RH_RF95_REG_01_OP_MODE), HEX);
    ...
    //nrf_gpio_pin_dir_set(RFM95_INT, NRF_GPIO_PIN_DIR_INPUT);
